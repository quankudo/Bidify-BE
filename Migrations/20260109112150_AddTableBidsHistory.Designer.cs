...
namespace bidify_be.Migrations
{
    ...
    [Migration("20260109112150_AddTableBidsHistory")]
    partial class AddTableBidsHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("bidify_be.Domain.Entities.FileStorage", b =>
                {
                    b.Property<string>("PublicId")
                        .HasMaxLength(255)
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("bidify_be.Domain.Entities.TopupTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("bidify_be.Domain.Entities.UserNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("bidify_be.Domain.Entities.WalletTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("bidify_be.Domain.Entities.UserNotification", b =>
                {
                    b.HasOne("bidify_be.Domain.Entities.Notification", "Notification")
